            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="profil-link">
                        <a href="https://www.facebook.com/upgrade.root">
                            <span style="text-transform: none;">Liên hệ Admin</span>
                            <img src="https://graph.fb.me/100005873862128/picture" class="img-circle" alt="">
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <nav>
            <ul class="nav luna-nav">
                ...
                <li class="nav-info">
                    ...
                    <div class="m-t-xs">
                        <span class="c-white">BotCamXuc</span> Phiên bản <?php echo $version; ?>  với tính năng mới lạ hơn, người dùng được chọn nhiều cảm xúc hơn để Bot auto.
                    </div>
                </li>
            </ul>
        </nav>
                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        ...
                        <div class="header-title">
                            ...
                            <small>
                                Phiên bản Bot 1.0 dùng token, token dễ bị die nên Làm Bằng cookie sẽ không bị xác minh danh tính
                            </small>
                        </div>
                    </div>
                    <hr>
